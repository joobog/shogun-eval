...
#Last.dir("/home/betke/install/shogun/home/betke/Rpackages")

library(methods)
#dyn.load("~/install/shogun/usr/local/lib/libshogun.so")
#dyn.load("~/install/shogun/home/betke/Rpackages/shogun/libs/modshogun.so")
